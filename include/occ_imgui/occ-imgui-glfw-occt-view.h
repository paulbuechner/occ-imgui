...
private:
    ...
    static void onMouseScrollCallback(GLFWwindow* theWin, const double theOffsetX, const double theOffsetY)
    {
        toView(theWin)->onMouseScroll(theOffsetX, theOffsetY);
    }

    //! Mouse click callback.
    static void onMouseButtonCallback(GLFWwindow* theWin, const int theButton, const int theAction, const int theMods)
    {
