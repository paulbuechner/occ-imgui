> This project is based on the awesome work of Shing Liu. Check out his original repository at
> https://github.com/eryar/OcctImgui

# occ-imgui

OpenCASCADE + GLFW + IMGUI + vcpkg Sample.

![occt imgui](assets/occt-imgui.png "opencascade imgui")
...
this goal and lacks certain features commonly found in more high-level libraries.
...
Vcpkg is a free C/C++ package manager for acquiring and building open source libraries on Windows, Linux and MacOS.
...
cmake --preset occ-imgui-ninja-multiconfiguration-vcpkg
